  ...
  return (
    <motion.div
      ...
      style={{
        ...
        padding: '32px',
        width: '100%',
        minHeight: isExpanded ? '700px' : '320px',
    ...
    >
      <AnimatePresence mode="wait">
        {!isExpanded ? (
          ...
          >
            {/* Title */}
            <h3 className="zz-dashboard-small" style={{ marginBottom: '24px' }}>
              {cardData.title}
            </h3>

            {/* Big Impact Number */}
            <div 
              className="zz-dashboard-big"
              style={{ 
                marginBottom: '8px',
                textAlign: 'center'
              }}
            >
              {cardData.impactNumber}
            </div>

            {/* Impact Unit */}
            <div 
              className="zz-dashboard-label"
              style={{ 
                marginBottom: '24px',
                textAlign: 'center'
              }}
          ...
          >
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
              <div style={{ flex: 1 }}>
                <h3 className="zz-dashboard-medium" style={{ marginBottom: '16px' }}>
                  {cardData.title}
                </h3>
            ...
            {/* Big Impact Display */}
            <div style={{ textAlign: 'center', padding: '24px', border: '2px solid var(--zz-border)' }}>
              <div className="zz-dashboard-big" style={{ marginBottom: '8px' }}>
                {cardData.impactNumber}
              </div>
            ...
            {impactFeedback && (
              ...
              >
                ...
                <div className="zz-dashboard-small" style={{ marginBottom: '8px' }}>
                  {impactFeedback.carbon}kg
                </div>
                <div className="zz-dashboard-small" style={{ marginBottom: '16px' }}>
                  £{impactFeedback.money}
                </div>
                <div className="zz-dashboard-label">
